...
export class UpdateRefreshTokenRelations1627954845666 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_refresh_token" ("id" varchar PRIMARY KEY NOT NULL, "expiresOn" datetime NOT NULL, "userIdId" varchar NOT NULL, CONSTRAINT "UQ_dc078a0cdb9e929c9dad2fc6707" UNIQUE ("userIdId"))`);
        await queryRunner.query(`INSERT INTO "temporary_refresh_token"("id", "expiresOn", "userIdId") SELECT "id", "expiresOn", "userIdId" FROM "refresh_token"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_refresh_token" ("id" varchar PRIMARY KEY NOT NULL, "expiresOn" datetime NOT NULL, "user_id" varchar NOT NULL, CONSTRAINT "UQ_6bbe63d2fe75e7f0ba1710351d4" UNIQUE ("user_id"))`);
        await queryRunner.query(`INSERT INTO "temporary_refresh_token"("id", "expiresOn", "user_id") SELECT "id", "expiresOn", "userIdId" FROM "refresh_token"`);
        await queryRunner.query(`DROP TABLE "refresh_token"`);
        await queryRunner.query(`ALTER TABLE "temporary_refresh_token" RENAME TO "refresh_token"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "refresh_token" ("id" varchar PRIMARY KEY NOT NULL, "expiresOn" datetime NOT NULL, "user_id" varchar NOT NULL, CONSTRAINT "UQ_6bbe63d2fe75e7f0ba1710351d4" UNIQUE ("user_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "refresh_token" RENAME TO "temporary_refresh_token"`);
        await queryRunner.query(`CREATE TABLE "refresh_token" ("id" varchar PRIMARY KEY NOT NULL, "expiresOn" datetime NOT NULL, "userIdId" varchar NOT NULL, CONSTRAINT "UQ_dc078a0cdb9e929c9dad2fc6707" UNIQUE ("userIdId"))`);
        await queryRunner.query(`INSERT INTO "refresh_token"("id", "expiresOn", "userIdId") SELECT "id", "expiresOn", "user_id" FROM "temporary_refresh_token"`);
        await queryRunner.query(`DROP TABLE "temporary_refresh_token"`);
        await queryRunner.query(`ALTER TABLE "authors" RENAME TO "temporary_authors"`);
        ...
        await queryRunner.query(`DROP TABLE "temporary_authors"`);
        await queryRunner.query(`ALTER TABLE "refresh_token" RENAME TO "temporary_refresh_token"`);
        await queryRunner.query(`CREATE TABLE "refresh_token" ("id" varchar PRIMARY KEY NOT NULL, "expiresOn" datetime NOT NULL, "userIdId" varchar NOT NULL, CONSTRAINT "UQ_dc078a0cdb9e929c9dad2fc6707" UNIQUE ("userIdId"), CONSTRAINT "FK_e516f42344dfb8d3938a5a0109a" FOREIGN KEY ("userIdId") REFERENCES "authors" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "refresh_token"("id", "expiresOn", "userIdId") SELECT "id", "expiresOn", "userIdId" FROM "temporary_refresh_token"`);
        await queryRunner.query(`DROP TABLE "temporary_refresh_token"`);
    }
