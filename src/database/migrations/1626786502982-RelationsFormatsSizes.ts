...
export class RelationsFormatsSizes1626786502982 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "thumbnail" ("id" varchar PRIMARY KEY NOT NULL, "width" integer NOT NULL, "height" integer NOT NULL, "url" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')))`);
        await queryRunner.query(`CREATE TABLE "temporary_formats" ("id" varchar PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "largeId" varchar, "mediumId" varchar, "smallId" varchar, "thumbnailId" varchar, CONSTRAINT "UQ_d8d3269d66232033016a529a74a" UNIQUE ("largeId"), CONSTRAINT "UQ_927685b02efb946412628456371" UNIQUE ("mediumId"), CONSTRAINT "UQ_38257b37aa78c36d231e8678a5f" UNIQUE ("smallId"), CONSTRAINT "UQ_d9a6f5cdc2201a4ba48afb648dc" UNIQUE ("thumbnailId"))`);
        await queryRunner.query(`INSERT INTO "temporary_formats"("id", "created_at", "updated_at") SELECT "id", "created_at", "updated_at" FROM "formats"`);
        await queryRunner.query(`DROP TABLE "formats"`);
        await queryRunner.query(`ALTER TABLE "temporary_formats" RENAME TO "formats"`);
        await queryRunner.query(`CREATE TABLE "temporary_large" ("id" varchar PRIMARY KEY NOT NULL, "width" integer NOT NULL, "height" integer NOT NULL, "url" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')))`);
        await queryRunner.query(`INSERT INTO "temporary_large"("id", "width", "height", "url", "created_at", "updated_at") SELECT "id", "width", "height", "url", "created_at", "updated_at" FROM "large"`);
        await queryRunner.query(`DROP TABLE "large"`);
        await queryRunner.query(`ALTER TABLE "temporary_large" RENAME TO "large"`);
        await queryRunner.query(`CREATE TABLE "temporary_medium" ("id" varchar PRIMARY KEY NOT NULL, "width" integer NOT NULL, "height" integer NOT NULL, "url" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')))`);
        await queryRunner.query(`INSERT INTO "temporary_medium"("id", "width", "height", "url", "created_at", "updated_at") SELECT "id", "width", "height", "url", "created_at", "updated_at" FROM "medium"`);
        await queryRunner.query(`DROP TABLE "medium"`);
        await queryRunner.query(`ALTER TABLE "temporary_medium" RENAME TO "medium"`);
        await queryRunner.query(`CREATE TABLE "temporary_small" ("id" varchar PRIMARY KEY NOT NULL, "width" integer NOT NULL, "height" integer NOT NULL, "url" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')))`);
        await queryRunner.query(`INSERT INTO "temporary_small"("id", "width", "height", "url", "created_at", "updated_at") SELECT "id", "width", "height", "url", "created_at", "updated_at" FROM "small"`);
        ...
        await queryRunner.query(`INSERT INTO "temporary_formats"("id", "created_at", "updated_at", "largeId", "mediumId", "smallId", "thumbnailId") SELECT "id", "created_at", "updated_at", "largeId", "mediumId", "smallId", "thumbnailId" FROM "formats"`);
        await queryRunner.query(`DROP TABLE "formats"`);
        await queryRunner.query(`ALTER TABLE "temporary_formats" RENAME TO "formats"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "formats"("id", "created_at", "updated_at", "largeId", "mediumId", "smallId", "thumbnailId") SELECT "id", "created_at", "updated_at", "largeId", "mediumId", "smallId", "thumbnailId" FROM "temporary_formats"`);
        await queryRunner.query(`DROP TABLE "temporary_formats"`);
        await queryRunner.query(`ALTER TABLE "small" RENAME TO "temporary_small"`);
        await queryRunner.query(`CREATE TABLE "small" ("id" uuid PRIMARY KEY NOT NULL, "width" integer NOT NULL, "height" integer NOT NULL, "url" varchar NOT NULL, "created_at" timestamp NOT NULL DEFAULT (now()), "updated_at" timestamp NOT NULL DEFAULT (now()))`);
        await queryRunner.query(`INSERT INTO "small"("id", "width", "height", "url", "created_at", "updated_at") SELECT "id", "width", "height", "url", "created_at", "updated_at" FROM "temporary_small"`);
        await queryRunner.query(`DROP TABLE "temporary_small"`);
        await queryRunner.query(`ALTER TABLE "medium" RENAME TO "temporary_medium"`);
        await queryRunner.query(`CREATE TABLE "medium" ("id" uuid PRIMARY KEY NOT NULL, "width" integer NOT NULL, "height" integer NOT NULL, "url" varchar NOT NULL, "created_at" timestamp NOT NULL DEFAULT (now()), "updated_at" timestamp NOT NULL DEFAULT (now()))`);
        await queryRunner.query(`INSERT INTO "medium"("id", "width", "height", "url", "created_at", "updated_at") SELECT "id", "width", "height", "url", "created_at", "updated_at" FROM "temporary_medium"`);
        await queryRunner.query(`DROP TABLE "temporary_medium"`);
        await queryRunner.query(`ALTER TABLE "large" RENAME TO "temporary_large"`);
        await queryRunner.query(`CREATE TABLE "large" ("id" uuid PRIMARY KEY NOT NULL, "width" integer NOT NULL, "height" integer NOT NULL, "url" varchar NOT NULL, "created_at" timestamp NOT NULL DEFAULT (now()), "updated_at" timestamp NOT NULL DEFAULT (now()))`);
        await queryRunner.query(`INSERT INTO "large"("id", "width", "height", "url", "created_at", "updated_at") SELECT "id", "width", "height", "url", "created_at", "updated_at" FROM "temporary_large"`);
        await queryRunner.query(`DROP TABLE "temporary_large"`);
        await queryRunner.query(`ALTER TABLE "formats" RENAME TO "temporary_formats"`);
        await queryRunner.query(`CREATE TABLE "formats" ("id" varchar PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')))`);
        await queryRunner.query(`INSERT INTO "formats"("id", "created_at", "updated_at") SELECT "id", "created_at", "updated_at" FROM "temporary_formats"`);
        await queryRunner.query(`DROP TABLE "temporary_formats"`);
